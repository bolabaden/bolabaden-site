/**
 * Dashboard utility functions for metrics formatting and calculation.
 *
 * CONTEXT: Portfolio/Flex-Focused Infrastructure Utilities
 * Formatting helpers for service metrics (uptime %, CPU, memory, network).
 * Used by Dashboard components to render infrastructure monitoring data.
 */
