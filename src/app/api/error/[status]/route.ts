...
<head>
    ...
    <title>Error ${status} - ${config.SITE_NAME}</title>
    ...
    <script>
        function searchService() {
            ...
            if (query) {
                ...
                const serviceUrl = \`https://\${query}.${config.SITE_DOMAIN}\`;
        ...
        function reportIssue() {
            ...
            const subject = encodeURIComponent(\`Error ${status} Report - ${config.SITE_NAME}\`);
            const body = encodeURIComponent(\`Error Details:\n\nStatus: ${status}\nURL: ${originalUrl}\nTime: \${errorData.timestamp}\nUser Agent: \${errorData.userAgent}\n\nDescription:\n[Please describe what you were trying to do]\`);
            
            window.open(\`mailto:${config.CONTACT_EMAIL}?subject=\${subject}&body=\${body}\`);
        }
    ...
    <div class="container mx-auto px-4 py-12 relative z-10">
        <div class="max-w-2xl mx-auto text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
                <a href="${config.SITE_URL}" class="inline-flex items-center gap-2 px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all duration-200 shadow-lg">
                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="glass rounded-lg p-6 mb-8">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
                    ...
                    <a href="${config.SITE_URL}/dashboard" class="flex flex-col items-center gap-2 p-3 rounded-lg hover:bg-white/5 transition-colors text-center">
            ...
            <div class="glass rounded-lg p-6 mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="space-y-3">
                        <a href="mailto:${config.CONTACT_EMAIL}" class="flex items-center gap-3 p-3 rounded-lg hover:bg-white/5 transition-colors">
                            <svg class="h-5 w-5 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                            </svg>
                            <div>
                                <div class="text-sm font-medium text-white">Email Support</div>
                                <div class="text-xs text-gray-400">${config.CONTACT_EMAIL}</div>
                            </div>
                        </a>
                    ...
                    <div class="space-y-3">
                        ...
                        <a href="${config.GITHUB_URL}" class="flex items-center gap-3 p-3 rounded-lg hover:bg-white/5 transition-colors">
