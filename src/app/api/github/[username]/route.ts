 ...
 * Fetches all public repositories for a GitHub user (no filtering/scoring).
 *
 * CONTEXT: Generic/Reference Data
 * Returns raw repo list without curation, filtering, or portfolio-specific scoring.
 * Used by multiple endpoints and data layers for different purposes.
 * See /api/projects/intelligence for portfolio-curated version
 *
 * Query params:
