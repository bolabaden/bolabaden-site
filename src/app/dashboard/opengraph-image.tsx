  ...
  return new ImageResponse(
    <div
      style={{
        ...
        background:
          "linear-gradient(135deg, hsl(222 47% 11%) 0%, hsl(217 32% 17%) 66%, hsl(217 91% 60% / 0.28) 100%)",
        color: "hsl(210 20% 98%)",
        padding: "62px",
