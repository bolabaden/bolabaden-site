...
export const projects: Project[] = [
  {
    ...
    description: 'Production-grade self-hosted infrastructure powering bolabaden.org and 8+ live services.',
...
**Tech Stack:** Docker, Traefik, Redis, MongoDB, Prometheus, Grafana, Portainer`,
  ...
  },
  {
    ...
    description: 'Modern portfolio site with SSR, optimized performance, and real-time service integration.',
...
**Tech Stack:** Next.js 14, TypeScript, Tailwind CSS, Framer Motion, Docker`,
  ...
  },
  {
    id: 'cloudcradle',
    title: 'CloudCradle',
    description: 'Terraform-based Oracle Cloud automation — provisions VCNs, clusters, and instances in minutes.',
...
**Tech Stack:** Terraform, Python, Oracle Cloud Infrastructure SDK, Click CLI`,
  ...
  },
  {
    ...
    description: 'Multi-model research platform with intelligent fallbacks and cost optimization.',
...
**Tech Stack:** Python, FastAPI, React, LiteLLM, Docker, Redis`,
  ...
  },
  {
    id: 'llm_fallbacks',
    title: 'LLM Fallbacks',
    description: 'Python library for intelligent LLM provider fallbacks with cost optimization.',
...
**Tech Stack:** Python, LiteLLM, Pydantic, Typer CLI`,
  ...
  },
  {
    id: 'constellation',
    title: 'Constellation',
    description: 'Service orchestration platform with Prometheus monitoring and canary rollout support.',
