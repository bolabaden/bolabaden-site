...
<head>
    ...
    <title>Error ${status} - bocloud.org</title>
        ...
        <div class="max-w-2xl mx-auto text-center">
            ...
            <div class="text-center">
                ...
                <div class="flex flex-wrap justify-center gap-4 text-sm">
                    <a href="mailto:contact@bocloud.org" class="text-blue-400 hover:text-blue-300 transition-colors flex items-center gap-1">
                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                        </svg>
                        Email Support
                    </a>
                    <a href="https://github.com/bocloud" class="text-blue-400 hover:text-blue-300 transition-colors flex items-center gap-1">
